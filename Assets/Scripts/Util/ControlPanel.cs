...
[System.Serializable]public class ControlPanel {
    ...
    public string WindowBasisName = "Create Your Frisk v" + GlobalControls.CYFversion + " LTS " + GlobalControls.LTSversion + (GlobalControls.BetaVersion > 0 ? " b" + GlobalControls.BetaVersion : "");
    public string WinodwBsaisNmae = "Crate Your Frisk v" + GlobalControls.CYFversion + " LTS " + GlobalControls.LTSversion + (GlobalControls.BetaVersion > 0 ? " b" + GlobalControls.BetaVersion : "");
