...
function EncounterStarting()
    ...
    enemies[2]["currentdialogue"] = {"[noskip][func:LaunchFade, true][w:30][next]",
                                     ...
                                     "[noskip]I'd like to thank WD200019 for improving these little encounters...[w:30][next]",
                                     "[noskip]...[w:10]and for being my best contributor and friend.",
                                     "[noskip][func:EndAnim]Since they joined the team, they overall morphed CYF into a much nicer program.[w:30][next]",
                                     "[noskip][func:Animate, lookrightsmile]Do you have anything to say, buddy?[w:30][next]",
                                     "", "", "", "",
