...
public class LuaEnemyController : EnemyController {
    ...
    private static ParticleSystem spareSmokePrefab;
    public static GameObject MonsterDusterPrefab;
    ...
    private void Start() {
        try {
            GameObject go = Resources.Load<GameObject>("Prefabs/MonsterDuster");
            if (go != null && go.ToString().ToLower() != "null")
                MonsterDusterPrefab = go;
            ...
            Sprite _spr = Resources.Load<Sprite>("Sprites/UI/SpeechBubbles/right");
            if (_spr != null && _spr.ToString().ToLower() != "null")
                textBubbleSprite = _spr;
    ...
    public void DoSpare() {
        ...
        ParticleSystem _spareSmoke = Resources.Load<ParticleSystem>("Prefabs/MonsterSpareParticleSys");
        if (_spareSmoke != null && _spareSmoke.ToString().ToLower() != "null")
            spareSmokePrefab = _spareSmoke;
        ParticleSystem spareSmoke = Instantiate(spareSmokePrefab);
        spareSmoke.Emit(10);
